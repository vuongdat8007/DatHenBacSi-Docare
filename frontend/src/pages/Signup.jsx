          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form onSubmit={submitHandler} className="py-4 md:py-0">
              ...
              <div className='mb-5 items-center justify-between'>
                ...
                <label htmlFor="" className='text-headingColor font-bold text-[16px] leading-7 ml-10'>
                  Giới tính:
                  <select 
                    name="gender" 
              ...
              <div className='mb-5 flex items-center gap-3'>
                ...
                <div className='relative w-[130px] h-[50px]'>
                  ...
                  <label htmlFor="customFile" className='absolute top-0 left-0 w-full h-full flex items-centerpx-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer pl-5'>
                    Tải ảnh lên
                  </label>
                </div>
              </div>
